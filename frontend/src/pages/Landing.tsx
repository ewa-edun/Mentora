      ...
      <section className="relative px-6 py-20">
        ...
        <div className="relative z-10 max-w-7xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            ...
            <button className="bg-white/20 backdrop-blur-sm border border-white/30 text-neutral-700 px-8 py-4 rounded-xl font-semibold text-lg hover:bg-white/30 hover:border-white/50 transform hover:scale-105 transition-all duration-300 shadow-lg flex items-center justify-center gap-3 group">
